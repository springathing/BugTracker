...
namespace mblyakher_bugtracker.Controllers
{
    ...
    public class ManageController : Universal
    {
       ...
       //An asynchronous method is one that we call to start the lengthy operation.The method should do what it needs to start
       //the operation and return "very quickly" so that there are no processing delays.
       [HttpPost]
       [ValidateAntiForgeryToken]
